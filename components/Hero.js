      ...
      <div className="relative z-20 flex flex-col justify-center items-center lg:items-start lg:text-left w-full lg:w-2/5 px-6 sm:px-10 lg:px-12 py-20 space-y-6">
        ...
        <div className="block lg:hidden mb-6 animate-fade-in">
          <Image
            ...
            width={350}   // ⬅️ Taille augmentée ici
            height={140}  // ⬅️ Et ici
            priority
        ...
        {/* ✅ Texte visible uniquement sur medium & desktop */}
        <h1 className="hidden lg:block text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-extrabold leading-snug lg:leading-tight drop-shadow-lg">
          OUT OF THE BOX <br />
          <span className="text-[#e8e56d]">Design Studio</span>
        </h1>

        <p className="text-gray-200 text-base sm:text-lg md:text-xl leading-relaxed max-w-md text-center lg:text-left">
        ...
        {/* Localisation */}
        <p className="mt-2 text-gray-400 text-sm sm:text-base uppercase tracking-widest text-center lg:text-left">
