      ...
      <div className="max-w-5xl mx-auto pt-12">
        ...
        >
          ...
          <div className="space-y-4 text-gray-200 text-sm sm:text-base leading-relaxed">
            <p>
              Our studio offers complete interior architecture and detailing for
              every space within your home. Each area is designed to match your
              lifestyle and aesthetic vision.
            </p>
            <p>
              Expertise includes gourmet kitchens, luxury bathrooms, walk-in
              wardrobes, entertainment lounges, and outdoor living areas.
            </p>
          </div>
