export default function Head() {
  return (
    <>
      {/* Titre */}
      <title>Out of the Box Design Studio | Luxury Interior & Architectural Services</title>

      {/* Meta description */}
      <meta
        name="description"
        content="Out of the Box Design Studio offers luxury custom home and interior design services, including bespoke architecture, virtual interior design, and premium home solutions tailored to your vision."
      />

      {/* Mots-clés */}
      <meta
        name="keywords"
        content="Interior Design, Luxury Home, Custom Architecture, Virtual Design, Home Renovation, Luxury Materials, Bespoke Interiors, Premium Design Services"
      />

      {/* Auteur */}
      <meta name="author" content="Out of the Box Design Studio" />
